...
class SettlementController(
    ...
    fun createSettlement(
        @RequestBody command: CreateSettlementCommand,
    ...
    fun getSettlementsByCompanyAndPeriod(
        ...
        val result =
            settlementService.getSettlementsByCompanyAndPeriod(
    ...
    fun getSettlementsByCompanyAndStatus(
        ...
        val result =
            settlementService.getSettlementsByCompanyAndStatus(
                UUID.fromString(companyId),
                status,
            )
        return ResponseEntity.ok(result)
