...
const ShippingDetailModal: React.FC<ShippingDetailModalProps> = ({ isOpen, onClose, shipmentId }) => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="shipping-detail-title">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-3">
                <h2 id="shipping-detail-title" className="text-xl font-bold text-slate-900">{shipmentId}</h2>
