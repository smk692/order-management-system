...
const LogDetailModal: React.FC<LogDetailModalProps> = ({ isOpen, onClose, logId }) => {
  ...
  return (
    <div className="fixed inset-0 z-[400] flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="log-detail-modal-title">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <div className="flex items-center gap-3">
                 <h2 id="log-detail-modal-title" className="text-xl font-black text-white italic tracking-tight uppercase">API Intelligence Analyzer</h2>
